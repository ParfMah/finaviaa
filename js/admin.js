...
function renderImages() {
  ...
  content.innerHTML = `
    <div class="admin-card">
      <div class="admin-card-header">
        <h3 class="admin-card-title">🖼️ Médiathèque</h3>
      ...
      <div class="admin-card-body">
        ...
        <div class="admin-upload-zone" id="uploadZone"
          ...
          <div class="admin-upload-sub">WebP, PNG, JPG • Max 5 MB par image</div>
        </div>
        ...
        <div style="margin-top:1.5rem;">
          <h4 style="font-size:0.875rem;font-weight:600;color:#64748B;margin-bottom:1rem;text-transform:uppercase;letter-spacing:0.05em;">
            Images existantes (${getPlaceholderImages().length})
          </h4>
          <div class="admin-gallery-grid">
            ${getPlaceholderImages().map(img => `
              <div class="admin-gallery-item">
                ...
                <div class="admin-gallery-overlay">
                  ...
                  <button class="admin-gallery-action" title="Supprimer" onclick="this.closest('.admin-gallery-item').remove()">
                ...
                <div style="padding:4px 8px;font-size:0.65rem;color:#64748B;background:#F8FAFC;border-top:1px solid #E2E8F0;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">
                  ${img.name}
                </div>
              </div>
            `).join('')}
...
function processImageFiles(files) {
  ...
  if (window.showToast) {
    window.showToast(`${files.length} image(s) téléchargée(s) avec succès !`, 'success');
  }
  // En production : upload vers le backend
}
